...
**See also [`chatsense-master-plan.md`](./chatsense-master-plan.md)** — the authoritative baton (2026-07-12); its §16 prompt supersedes the §20 prompt below. This document's context rules (neutral default copy, friendship second, family restraint, work unmarketed, groups secondary) remain binding and are recorded in the master plan's decision set.
